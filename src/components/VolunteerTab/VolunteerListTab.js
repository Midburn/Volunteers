...
export default class VolunteerListTab extends Component {
  ...
  getCurrentDepartment = () => {
    ...
    return departments && departments.find(department => department._id === departmentId)
  }
  ...
  render() {
    console.log('this.getCurrentDepartment', this.getCurrentDepartment())
        ...
        <div className="container card">
          ...
          <div className="volunteer-list-list-title">
            <span>Volunteers: <span
              className="counter">({`${this.state.visibleVolunteers.length} / ${this.state.volunteers.length}`})
                </span>
            </span> {
              // this.state.activeRound && 

              <span className="round-ticket-count">Allocated Tickets: (/)</span>}
